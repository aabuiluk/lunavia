      ...
      <div className="right-side">
        ...
        <div className="form-wrapper">
          <div className="form-header">
            <span className="create-account-tag">WELCOME BACK</span>
            <h2>Ready when you are.</h2>
            <p>Log in to pick up where your travel plans left off.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="reg-form">
            ...
            <div className="forgot-password-container">
              <a href="/restore" className="forgot-link">Forgot password? <span>Restore it</span></a>
            </div>
          ...
          <p className="login-footer">
            New to Lunavia? <a href="/register">Create one</a>
          </p>
        </div>
      </div>
    </div>
